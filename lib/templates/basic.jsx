import { LogoIcon, LocationIcon, PhoneIcon, TickIcon } from '@icons/icons';
    ...
    .flier-container > .footer {
      ...
      <div id="capture-target" class="flier-container">
        <div class="img">
          ...
          <img src="${data.images[0]}" class="img_1" />
        </div>
        <div class="content">
          <div class="header">
        ...
        <div class="footer">
         <span class="agent">${data.agent.name} | ${PhoneIcon} ${data.agent.phone}</span>
